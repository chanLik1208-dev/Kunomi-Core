...
_P_ANGLE_X    = _idle_cfg.get("param_angle_x",    "ParamAngleX")
_P_ANGLE_Y    = _idle_cfg.get("param_angle_y",    "ParamAngleY")
_P_ANGLE_Z    = _idle_cfg.get("param_angle_z",    "ParamAngleZ")
_P_BREATH     = _idle_cfg.get("param_breath",     "ParamBreath")
_P_EYE_BALL_X = _idle_cfg.get("param_eye_ball_x", "ParamEyeBallX")
_P_EYE_BALL_Y = _idle_cfg.get("param_eye_ball_y", "ParamEyeBallY")
_P_EYE_L_OPEN = _idle_cfg.get("param_eye_l_open", "ParamEyeLOpen")
_P_EYE_R_OPEN = _idle_cfg.get("param_eye_r_open", "ParamEyeROpen")
_P_MOUTH_OPEN = _idle_cfg.get("param_mouth_open",  "ParamMouthOpenY")
